...
class MirrorUser {
    ...
    init(email: String, displayName: String, documentID: String, exists: Bool) {
        self.email = email
    ...
    convenience init(user: User) {
        self.init(email: user.email ?? "", displayName: user.displayName ?? "", documentID: user.uid, exists: false)
    }
